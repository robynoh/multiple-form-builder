...
<html lang="en">
    ...
    <body class="login"  >
        <div class="container sm:px-10" >
            <div class="block xl:grid grid-cols-2 gap-4"  >
                ...
                <div class="hidden xl:flex flex-col min-h-screen"  >
                    ...
                    <div class="my-auto" >
                        <img alt="Midone Tailwind HTML Admin Template" class="-intro-x" src="dist/images/illustration.png">
                        <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10" style="color:#000000" >
                            A few more clicks 
                            <br>
                            to Improve your conversion
                        </div>
                        <div class="-intro-x mt-5 text-lg text-white" style="color:#333333"> Create and manage all your landing page, optin forms<br/> and email list in one place.</div>
                    </div>
                </div>
                <!-- END: Login Info -->
                <!-- BEGIN: Login Form -->
        ...
        @endif
                        ...
                        <div class="intro-x mt-2 text-gray-500 xl:hidden text-center" >A few more clicks to start increasing your conversion. Create and manage all your landing page, optin forms and email list in one place.</div>
                ...
                @endif
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <button class="button button--lg w-full xl:w-32 text-white bg-theme-9 xl:mr-3">Login</button>
