...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Feature Request</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                        ...
                        <tbody>
                          @foreach($users as $user) 
                            <tr>
                                ...
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap"><?php if($user->email_verified_at==null){?> <span class="px-3 py-2 rounded-full bg-theme-13 text-white mr-1">Unverified</span> <?php }else{?> <span class="px-3 py-2 rounded-full bg-theme-9 text-white mr-1">Verified</span>  <?php }?></div>
                                ...
                                <td class="w-40 border-b">
                                <div class="font-medium whitespace-no-wrap text-theme-6">  <a  id="deleteUser{{ $user->id}}" data-userid="{{$user->id}}" href="javascript:void(0)" onclick="showAlertfrm3({{ $user->id}});"  ><i data-feather="trash-2"></i></a></div>
                                </td>
