...
@section('content')
                   ...
                   <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" style="color:#84C345" class="breadcrumb--active">Add Video</a>  </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
    ...
    <div class="intro-y col-span-12 sm:col-span-12">
        ...
        <input name="title" type="text" class="input w-full border flex-1" placeholder="Enter title of video" value="{{ old('title') }}">
    </div>

    <div class="intro-y col-span-12 sm:col-span-12">
        <div class="mb-2"><b>Video url</b> </div>
        <input name="url" type="text" class="input w-full border flex-1" placeholder="Enter the embed script of video" value="{{ old('url') }}">
    </div>

    <div class="intro-y col-span-12 sm:col-span-12">
        <div class="mb-2"><b>Video image</b> </div>
        <input name="file" type="file" onchange="readURL(this);"   required/> </div>
