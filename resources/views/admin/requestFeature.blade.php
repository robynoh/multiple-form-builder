...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active"></a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<div class="grid grid-cols-12 gap-6 mt-1">
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full" style="font-size:14px;">
                        <thead>
                            ...
                            <th class="border-b-2 text-center whitespace-no-wrap">SENDER</th>
                               
                                <th class="border-b-2 text-center whitespace-no-wrap">SUMMARY</th>
                        ...
                        <tbody>
                          @foreach($requests as $request) 
                            <tr >
                            <td class="border-b"> <input name="request[]" type="checkbox" class="input border mr-2" id="vertical-checkbox-daniel-craig" value="{{$request->id}}">
                        </td>
                              
                            <td class="border-b" >
                                    <div class="font-medium whitespace-no-wrap">{{ucwords($request->name)}}
<?php if($request->request_status==1){?>
                                ...
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap ">{{$request->request_summary}}</div>
                                    
                                </td>
                              <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap">{{$request->request_type}}</div>
                                ...
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap">{{ \Carbon\Carbon::parse($request->created_at)->diffForHumans() }}</div>
                                    
                                </td>

                               
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap text-theme-10" ><a  href="/admin/show-request?req={{$request->id}}"  ><i data-feather="eye"></i></a></div>
