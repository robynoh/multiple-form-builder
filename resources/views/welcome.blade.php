...
<section id="home" class="section section-with-shape-divider custom-bg-color-1 border-0 pt-0 m-0">
					...
					<div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0">
						<div class="custom-section-svg-background appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="2300" style="background-image: url({{ asset('form/img/demos/startup-agency/backgrounds/morphing-bg-1.jpg')}}); background-size: cover; background-position: center;"></div>
						...
						<div class="container mt-5 pt-5">
							<div class="row align-items-center pt-5 mt-5 mt-lg-0 pt-lg-0">
								<div class="col-lg-6">
									<h1 class="font-weight-bold text-12 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Grow Your Email List</h1>
									<h2 class="font-weight-medium text-9 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">Turn Your Trafic into Revenue</h2>
									<p class="custom-font-secondary custom-font-size-1 mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Convert your abandoning visitors into subscribers and customers.</p>
									<a href="/how-it-works" class="btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800" style="color:#fff">Get Started</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-6 pb-sm-5 pb-lg-0 mb-5 mb-lg-0">
							<div class="custom-svg-wrapper-1 px-5">
								...
								<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.1, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<img src="{{ asset('form/img/demos/startup-agency/about-us-1.png')}}" class="img-fluid position-relative z-index-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1100" alt="" />
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							...
							<h2 class="font-weight-bold text-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Catch Your Visitors At The Best Moment</h2>
							<p class="custom-font-secondary custom-font-size-1 line-height-6 mb-4 pb-2 pr-lg-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">We found that many businesses struggle to collect emails or other information from visitors who click their links or visit their websites simply because the tools available are not easy to use and are expensive.
 We started with the simple goal of building powerful enterprise-level technology to help businesses grow their customer base and revenue.</p>
							<p class="custom-font-size-2 font-weight-light pb-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
Since our launch, we have been improving conversions for digital marketers and small independent businesses to Fortune 500 companies. Our customers are seeing huge increases in their subscriber growth and overall sales.
</p>
							<a href="login" data-hash data-hash-offset="70" class="btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000" style="color:#fff">Start Now</a>
						</div>
					</div>
				</div>
					...
					<div class="container pt-md-5 pb-1 pb-sm-5 my-5">
						<div class="row justify-content-center pt-5">
							<div class="col-lg-10 text-center">
								<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block mb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">OUR SOLUTIONS</span>
								<h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Increase Sales & Drive Conversion</h2>
								<p class="custom-font-size-2 font-weight-light appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Convert your visitors into lifelong readers and customers. Create proffessional sign-ups forms and landing pages with an advanced (yet easiest to use) tool.</p>
							</div>
						</div>
														...
														<div class="card-body p-3">
															<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
																<div class="thumb-info-wrapper">
																	<img src="{{ asset('form/img/demos/startup-agency/authors/author-1.jpg')}}" class="img-fluid" alt="John Doe" />
																</div>
															</div>
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Create Opt-in/Sign up Forms</h3>
												...
												<a href="#" class="text-decoration-none">
													<div class="card custom-card-style-1 box-shadow-4 my-3">
														<div class="card-body p-3">
															<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
																<div class="thumb-info-wrapper">
																	<img src="{{asset('form/img/demos/startup-agency/authors/author-2.jpg')}}" class="img-fluid" alt="John Doe" />
																</div>
															</div>
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Customize Sign Up Form Design</h3>
												...
												<a href="#" class="text-decoration-none">
													<div class="card custom-card-style-1 box-shadow-4 my-3">
														<div class="card-body p-3">
															<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
																<div class="thumb-info-wrapper">
																	<img src="{{asset('form/img/demos/startup-agency/authors/author-3.jpg')}}" class="img-fluid" alt="John Doe" />
																</div>
															</div>
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Multiple Niche Email List Separation</h3>
												...
												<a href="#" class="text-decoration-none">
													<div class="card custom-card-style-1 box-shadow-4 my-3">
														<div class="card-body p-3">
															<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
																<div class="thumb-info-wrapper">
																	<img src="{{ asset('form/img/demos/startup-agency/authors/author-4.jpg')}}" class="img-fluid" alt="John Doe" />
																</div>
															</div>
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Send Sign up Notification</h3>
			...
			<!---- I HOPE TO PUT PEOPLES TESTIMONIALS HERE
				...
				<div class="container mt-4 mb-5">
					<div id="pricing" class="row justify-content-center">
						<div class="col-lg-10 text-center">
							...
							<p class="custom-font-size-2 font-weight-light mb-4 pb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Affordable pricing plans with unlimited contact storage for your business without any setup fees.</p>
						</div>
					</div>
						...
						<div class="pricing-table pricing-table-no-gap custom-pricing-table-style-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
								...
								<div class="plan">
									...
									<div class="plan-features">
										...
										<li>Unlimited Subscribers</li>
											<li>1 Niche Board</li>
											<li>2 Sign ups forms</li>
											<li>2 Landing pages</li>
											
											<li>Watawazi branding</li>
									...
									<div class="plan-footer">
										<a href="login" class="btn btn-dark text-3 font-weight-bold border-0 btn-px-5 py-3">Get Started</a>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="plan">
									...
									<div class="plan-price">
										...
										<span class="price"><span class="price-unit">&#x20A6;</span>3,000</span>
										<label class="price-label">1 month</label>
									</div>
									<div class="plan-features">
										<ul>
											<li>Everything in <b>FREE PLAN</b> plus: </li>
											<li>5 Niche Boards</li>
											<li>5 landing Pages</li>
											<li>10 Sign Up Forms</li>
											<li>No Watawazi Branding</li>
											<li>Fully Customizable Design</li>
											<li>Instant Email Notofication</li>
										</ul>
									</div>
									<div class="plan-footer">
										<a href="login" class="btn btn-dark text-3 font-weight-bold border-0 btn-px-5 py-3">Get Started</a>
							...
							<div class="col-md-6 col-lg-3">
								<div class="plan plan-featured">
									...
									<div class="plan-price">
										<span class="price"><span class="price-unit">&#x20A6;</span>5,000</span>
										<label class="price-label">1 month</label>
									</div>
									<div class="plan-features">
										<ul>
											<li>Everything in <b>ESSENTIAL PLAN</b> Plus:</li>
											<li>Unlimited Niche Boards</li>
											<li>Unlimited Sign Up Forms</li>
											<li>Unlimited landing Pages</li>
											<li>Autorespond Thank You Email To subscribers</li>
											<li>-</li>
										</ul>
										
									</div>
									<div class="plan-footer">
										<a href="login" class="btn btn-gradient text-3 font-weight-bold btn-px-5 py-3" style="color:#fff">Get Started</a>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
								<div class="plan">
									...
									<div class="plan-price">
										...
										<label class="price-label">As desired</label>
									</div>
									<div class="plan-features">
										<ul>
											<li>Customised functions</li>
											<li>Niche Boards</li>
											<li>Sign up Forms</li>
											<li>Autorespond</li>
											<li>Sales page</li>
