...
<div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
                                    ...
                                    <a href="/users/create_form_edit/{{$tableid}}" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="chevron-left" class="w-6 h-6 mr-2"></i> Go back to all fields </a>
                              
                                   
                                   <span style="padding-left:10px">
                                        <a href="/users/create_custom_field_edit/{{$tableid}}" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="user-check" class="w-6 h-6 mr-2"></i> Customised </a>
</span>
