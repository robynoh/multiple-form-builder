...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">User</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> Collect Information<i data-feather="chevron-right" class="breadcrumb__icon"></i><a style="color:#84C345" href="" class="breadcrumb--active"> Niche Boards </a></div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<br/>
       ...
       <?php if($empty->count()<1){?>   
        
<table>
<tr>
<td>  
<a href="/users/create_form"  class="button w-45 mr-2 mb-2 flex items-center justify-center bg-theme-7 text-white"> <i data-feather="file-plus" class="w-4 h-4 mr-2"></i>Create niche board </a>  
...
<div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-19 text-theme-7" style="font-size:18px"> 
                            <i data-feather="meh" class="w-200 h-200 mr-2"></i> You have not created any niche board.  To create a niche board click the button above.
</div> 
<?php }?> 
                                    ...
                                    <div class="dropdown relative ml-auto sm:hidden">
                                        ...
                                        <div class="dropdown-box mt-5 absolute w-40 top-0 right-0 z-20">
                                            <div class="dropdown-box__content box p-2">
                                                ...
                                                <a href="/users/response/{{ UserController::encrypt_decrypt($data->table_id,true)}}" class="flex items-center p-2 transition duration-300 ease-in-out bg-white  hover:bg-gray-200 rounded-md"> <i data-feather="user-check" class="w-6 h-6 mr-2"></i> Entries</a>
                              
                                   
                             
                                               <a href="/users/interface/{{ UserController::encrypt_decrypt($data->table_id,true)}}" class="flex items-center p-2 transition duration-300 ease-in-out bg-white  hover:bg-gray-200 rounded-md"> <i data-feather="codesandbox" class="w-6 h-6 mr-2"></i>Interface</a>

                         

                            
                                  <a href="/users/create_form_edit/{{UserController::encrypt_decrypt($data->table_id,true)}}" class="flex items-center p-2 transition duration-300 ease-in-out bg-white  hover:bg-gray-200 rounded-md"> <i data-feather="edit" class="w-6 h-6 mr-2"></i> Edit</a>



<a href="/users/user_settings/{{ UserController::encrypt_decrypt($data->table_id,true)}}" class="flex items-center p-2 transition duration-300 ease-in-out bg-white  hover:bg-gray-200 rounded-md"> <i data-feather="settings" class="w-6 h-6 mr-2"></i> Settings</a>
                         



                              <a  id="deleteUser{{ $data->table_id}}" data-userid="{{$data->table_id}}" href="javascript:void(0)" onclick="showAlertfrm3({{ $data->table_id}});"  class="flex items-center p-2 transition duration-300 ease-in-out bg-white  hover:bg-gray-200 rounded-md"> <i data-feather="trash-2" class="w-6 h-6 mr-2"></i> Delete </a>
                                    ...
                                    <a href="/users/response/{{ UserController::encrypt_decrypt($data->table_id,true)}}" target="blank" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="user-check" class="w-6 h-6 mr-2"></i> Entries</a>
                              
                                   
                                    <span style="padding-left:10px">
                                        <a href="/users/interface/{{ UserController::encrypt_decrypt($data->table_id,true)}}" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="codesandbox" class="w-6 h-6 mr-2"></i>Interface</a>
</span>
                               

                                   <span style="padding-left:10px">
                                        <a href="/users/create_form_edit/{{UserController::encrypt_decrypt($data->table_id,true)}}" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="edit" class="w-6 h-6 mr-2"></i> Edit</a>
</span>

<span style="padding-left:10px">
<a href="/users/user_settings/{{ UserController::encrypt_decrypt($data->table_id,true)}}" target="blank" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="settings" class="w-6 h-6 mr-2"></i> Settings</a>
</span>                             


<span style="padding-left:10px">
                                    <a  id="deleteUser{{ $data->table_id}}" data-userid="{{$data->table_id}}" href="javascript:void(0)" onclick="showAlertfrm3({{ $data->table_id}});"  class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="trash-2" class="w-6 h-6 mr-2"></i> Delete </a>
</span>
                                ...
                                <div class="px-5">
                                        ...
                                        <div class="flex flex-col sm:flex-row items-center border-t border-gray-200 pt-5">
                                            <div class="w-full sm:w-auto flex justify-center sm:justify-start items-center border-b sm:border-b-0 border-gray-200 pb-5 sm:pb-0">
                                                ...
                                                <div class="text-gray-600">Time Created</div>
                                            </div>
...
window.location="/users/board/delete/"+$('#app_id3').val();
