...
<tr>
<td >  
<a href="/users/create_form_stp2/{{$tableid}}"  class="button w-45 mr-2 mb-2 flex items-center justify-center bg-theme-7 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i>Back To Basic Field </a>  
...
<div class="px-5 mt-5 ">
                    ...
                    <div class="px-5 sm:px-20   mt-5">
                       ...
                       <div> <label><b>Question</b></label>
                        ...
                        <input name="tableid" id="tableid" type="hidden" class="input w-full border mt-2" placeholder="Enter your question here" value="{{ Usercontroller::encrypt_decrypt($tableid,false) }}"> 
...
function deleteOptions(val){ 
 ...
 function deleteMenuOptions(val){ 
     ...
     var _token = $('input[name="_token"]').val();
     $.ajax({
         url:'/users/deletemenuoptiontemprary',
           method:'POST',
           data: {
