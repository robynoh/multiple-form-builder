...
<tr>
<td width="20%">  
<a href="/users/interface/{{ UserController::encrypt_decrypt($info->table_id,true)}}"  class="button w-45 mr-2 mb-2 flex items-center justify-center bg-theme-7 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i>Go Back </a>  
                                ...
                                <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                                    ...
                                    <a href="" class="w-3/5 file__icon file__icon--image mx-auto">
                                        <div class="file__icon--image__preview image-fit">
                                            <img id="blah" alt="Midone Tailwind HTML Admin Template" src="{{ asset($info->img)}}">
                                        </div>
                                    </a>
...
<br/>
    ...
    <div class="intro-y col-span-12 sm:col-span-12 mt-5">
        ...
        <input name="title" type="text" class="input w-full border flex-1" placeholder="Enter the name of your Business" value="{{ $info->title }}">
        <input name="interfaceid" type="hidden" class="input w-full border flex-1" placeholder="Enter the name of your Business" value="{{$info->id}}">
   
    </div>

    <div class="intro-y col-span-12 sm:col-span-12 mt-5">
        <div class="mb-2"><b>Redirect Link</b> </div>
        <input name="redirect" type="text" class="input w-full border flex-1" placeholder="Enter redirect link " value="{{ $info->redirect_link }}">
    </div>
    ...
    <div class="mb-2"><b>Description</b><span style="color:forestgreen"> </span></div>
     <textarea data-feature="basic" class="summernote" name="description" maxlength="160" onkeydown="limitText(this.form.description,this.form.countdown,160);" onkeyup='limitText(this.form.description,this.form.countdown,160);'>
     {{ $info->description }}
    </textarea>
