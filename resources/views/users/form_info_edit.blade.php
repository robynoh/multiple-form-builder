...
<tr>
<td width="20%">  
<a href="/users/new_field_edit/{{ UserController::encrypt_decrypt($tableid,true)}}"  class="button w-45 mr-2 mb-2 flex items-center justify-center bg-theme-7 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i>Go Back </a>  
...
<br/>
    ...
    <div class="intro-y col-span-12 sm:col-span-12 mt-5">
        ...
        <input name="organisation2" type="text" class="input w-full border flex-1" placeholder="Enter the name of your Business" value="{{ $info->company_name }}" disabled>
        <input name="organisation" type="hidden" class="input w-full border flex-1" placeholder="Enter the name of your Business" value="{{ $info->company_name }}">
