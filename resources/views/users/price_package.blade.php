...
<div class="intro-y flex justify-center mt-6">
                    <div class="pricing-tabs nav-tabs box rounded-full overflow-hidden flex"> <a data-toggle="tab" data-target="#layout-1-monthly-fees" href="javascript:;" class="flex-1 w-32 lg:w-40 py-2 lg:py-3 whitespace-no-wrap text-center active">Monthly Fees</a> <a data-toggle="tab" data-target="#" href="/users/my-package-annual" class="flex-1 w-32 lg:w-40 py-2 lg:py-3 whitespace-no-wrap text-center ">Annual Fees</a> </div>
                </div> 
                <br/> 
                    ...
                    <div class="tab-content">
                        <div class="tab-content__pane flex flex-col lg:flex-row active" id="layout-1-monthly-fees">
                            <div class="intro-y flex justify-center flex-col flex-1 text-center sm:px-10 lg:px-5 pb-10 lg:pb-0">
                                <div class="font-medium text-lg">Monthly Subscription</div>
                                <div class="mt-3 lg:text-justify text-gray-700">
                                    <p>You can choose to subscribe to use features of the application monthly. To subscribe for the annual package, click the annual fee tab above.</p>
                            ...
                            {{ csrf_field() }} 
                         <input type="hidden" name="metadata" value="{{ json_encode($array = ['package' =>'essential','type'=>'monthly']) }}" >
                         ...
                         <input type="hidden" name="reference" value="{{ Paystack::genTranxRef() }}">  
                                ...
                                <div class="text-gray-700 text-center mt-5 p-5"> Essential tools to get more leads from your existing traffic on a monthly base </div>
                                <div class="text-gray-600 px-10 text-center mx-auto mt-2 text-theme-9"><b><a a href="javascript:;" data-toggle="modal" data-target="#large-modal-size-preview">View Features</a></b></div>



                                <div class="modal" id="large-modal-size-preview" style="padding-left: 0px;">
                                        <div class="modal__content modal__content--lg p-10 text-center"> 
                                            
                                        <img alt="Midone Tailwind HTML Admin Template" src="{{ asset('dist/images/essentialPackage.jpg') }}">
             
                                    
                                        <div class="font-medium text-lg">Essential Package</div>
                                <div class="mt-3 lg:text-justify text-gray-700">
                                    <p>Essential tools to get more leads from your existing traffic</p>
                                    <p class="mt-2">
                                    
                                        <div class="border-t border-gray-200 mt-5 pt-5">

                                        <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md">  <b>Features</b> </a>
                                ...
                                <div class="modal" id="large-modal-size-preview2" style="padding-left: 0px;">
                                        <div class="modal__content modal__content--lg p-10 text-center"> 
                                            
                                    
                                      <img alt="Midone Tailwind HTML Admin Template" src="{{ asset('dist/images/proPackage.jpg') }}">
             
                                        <div class="font-medium text-lg">Pro Package</div>
                                                         <div class="mt-3 lg:text-justify text-gray-700">
                                    <p>Everything you need to get huge result fast from your existing trafic.</p>
                                    <p class="mt-2">
                                ...
                                <div class="flex justify-center">
                                    <div class="relative text-5xl font-semibold mt-8 mx-auto">  &nbsp; &#x20A6; 3,000 </div>
                                </div>
                                <button type="submit" class="button button--lg block text-white bg-theme-9 rounded-full mx-auto mt-8" value="Pay Now!">SUBSCRIBE</button>
</form>
                            </div>
                            <div class="intro-y flex-1 box py-16 lg:ml-5">
                            <form action="{{ route('pay') }}" accept-charset="UTF-8" method="POST">
                            {{ csrf_field() }} 
                         <input type="hidden" name="metadata" value="{{ json_encode($array =['package' =>'pro','type'=>'monthly']) }}" >
                         ...
                         <input type="hidden" name="reference" value="{{ Paystack::genTranxRef() }}">  
                                ...
                                <div class="text-gray-700 text-center mt-5 p-5"> Everything you need to get huge result fast from your existing trafic monthly. </div>
                                <div class="text-gray-600 px-10 text-center mx-auto mt-2 text-theme-9"><b><a a href="javascript:;" data-toggle="modal" data-target="#large-modal-size-preview2">View Features</a></b></div>
                                <div class="flex justify-center">
                                    <div class="relative text-5xl font-semibold mt-8 mx-auto">  &nbsp; &#x20A6; 5,000 </div>
                                </div>
