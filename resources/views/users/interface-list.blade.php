...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">User</a><i data-feather="chevron-right" class="breadcrumb__icon"></i><a style="color:#84C345" href="" class="breadcrumb--active"> Opt-in Interface </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
