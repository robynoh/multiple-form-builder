...
<br/>
                ...
                To be able to set up a sign up form to get the information of your leads using watawazi, you
                are required to go through just two steps. Which are creating a <b style="color:#006600"><a href="/users/getting-started-niche-board">Niche Board</a></b> first and <b style="color:#006600"><a href="/users/getting-started-interface">Creating an Interface</a></b> second
    
                
                </p>

                <a href="/users/getting-started-niche-board" class="flex items-center px-3 py-2 rounded-md" style="font-size:large">
                <div class="w-2 h-2 bg-theme-11 rounded-full mr-3"></div>
                                <u>   How to create a Niche Board </u>
                                </a>


                                <a href="/users/getting-started-interface" class="flex items-center px-3 py-2 rounded-md" style="font-size:large">
                                <div class="w-2 h-2 bg-theme-11 rounded-full mr-3"></div>
                                 <u> How to create an Interface.</u>
                                </a>

                                <a href="/users/getting-started-share" class="flex items-center px-3 py-2 rounded-md" style="font-size:large">
                                <div class="w-2 h-2 bg-theme-11 rounded-full mr-3"></div>
                                 <u> How to Share interface or signup forms.</u>
                                </a>

                                <a href="/users/getting-started-access-lead" class="flex items-center px-3 py-2 rounded-md" style="font-size:large">
                                <div class="w-2 h-2 bg-theme-11 rounded-full mr-3"></div>
                                 <u> How to access all submitted lead information for a Niche.</u>
                                </a>
