        ...
        <div class="mobile-menu md:hidden">
            <div class="mobile-menu-bar">
                <a href="" class="flex mr-auto">
                    <img alt="Midone Tailwind HTML Admin Template" src="{{ asset('dist/logo.png') }}">
                </a>
...
-->
                    <li>
                        <a style="color:black" href="/users" class="menu menu<?php if(Request::segment(2)=='verify'){?>--active<?php }?>">
                            <div class="menu__icon"> <i data-feather="slack"></i> </div>
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    <li>
                        <a style="color:black" href="/users" class="side-menu side-menu<?php if(Request::segment(2)=='verify'){?>--active<?php }?>">
